...
kernel_init_string_welcome db STATIC_COLOR_ASCII_GREEN_LIGHT, "Luna Operating System", STATIC_COLOR_ASCII_GRAY, " (v", KERNEL_version, ".", KERNEL_revision, " ", KERNEL_architecture, ")", STATIC_ASCII_NEW_LINE
kernel_init_string_welcome_end:
kernel_init_string_video db STATIC_COLOR_ASCII_GREEN_LIGHT, "::", STATIC_COLOR_ASCII_DEFAULT, " Video resolution ", STATIC_COLOR_ASCII_WHITE
...
kernel_init_string_storage_ide db STATIC_COLOR_ASCII_GREEN_LIGHT, "::", STATIC_COLOR_ASCII_DEFAULT, " IDE storage device: " , STATIC_ASCII_NEW_LINE
