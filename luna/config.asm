...
STATIC_LUNA_VIDEO_WIDTH_pixel equ 1920
STATIC_LUNA_VIDEO_HEIGHT_pixel equ 1080
STATIC_LUNA_VIDEO_DEPTH_bit equ 32
STATIC_LUNA_VIDEO_MODE_clean equ 0x8000
STATIC_LUNA_VIDEO_MODE_linear equ 0x4000

STATIC_LUNA_ERROR_a20 equ 0x4F41
STATIC_LUNA_ERROR_memory equ 0x4F4D
STATIC_LUNA_ERROR_disk equ 0x4F44
STATIC_LUNA_ERROR_video equ 0x4F56
...
struc STATIC_LUNA_VIDEO_STRUCTURE_VGA_INFO_BLOCK
...
struc STATIC_LUNA_VIDEO_STRUCTURE_MODE_INFO_BLOCK
